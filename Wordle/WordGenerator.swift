...
class WordGenerator {
  ...
  static let possibleWords = ["ABCDE", "APPLE", "BRAVE", "CHARM", "DELTA", "EAGLE", "FROST", "GLARE", "HASTE", "IMAGE", "JOKER", "KNOCK", "LARGE", "MEDIA", "NOBLE", "OPERA", "PRIZE", "QUERY", "RIVER", "SCALE", "TRACE", "UPPER", "VIVID", "WATCH", "XYLOPHONE", "YIELD", "ZEBRA"]
